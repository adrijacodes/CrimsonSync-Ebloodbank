...
export const eventData = [
  {
    eventName: "Night Life Blood Drive",
    date: "2025-06-17T23:00:00Z",
    venue: "Sector 5 Red Cross, Kolkata",
    city: "Kolkata",
    description:
      "Donate blood late at night and be someone’s miracle while the world sleeps.",
  },
  {
    eventName: "Midnight Donor Marathon",
    date: "2025-06-17T23:00:00Z",
    venue: "Cyber City Hub, Gurgaon",
    city: "Delhi",
    description:
      "Join Delhi’s midnight donation drive and become a beacon of hope tonight.",
  },

  // 2014 Events
  {
    eventName: "Legacy Drive - Delhi",
    date: "2014-03-10T09:00:00Z",
    venue: "Delhi University Grounds",
    city: "Delhi",
    description:
      "One of the first major drives in Delhi. Many lives saved through this initiative.",
  },
  {
    eventName: "2014 Blood Unity Fest",
    date: "2014-05-15T10:00:00Z",
    venue: "Bangalore Town Hall",
    city: "Bangalore",
    description:
      "The fest that started Bangalore’s annual blood donation campaigns.",
  },
  {
    eventName: "Hyderabad Healing Hands 2014",
    date: "2014-02-22T09:00:00Z",
    venue: "Secunderabad Red Camp",
    city: "Hyderabad",
    description:
      "A major milestone event connecting hundreds of donors in Hyderabad.",
  },
  {
    eventName: "Mumbai Lifesavers Day",
    date: "2014-04-01T09:00:00Z",
    venue: "Marine Drive Pavilion",
    city: "Mumbai",
    description:
      "Mumbai’s iconic blood drive that inspired the Red Drop movement.",
  },
  {
    eventName: "Red Pledge Kolkata",
    date: "2014-07-05T09:00:00Z",
    venue: "Eco Park, Kolkata",
    city: "Kolkata",
    description:
      "When the city pledged together to help the needy through donation.",
  },
  {
    eventName: "Unity Blood Circle - Chennai",
    date: "2014-08-15T09:00:00Z",
    venue: "Marina Beach Grounds",
    city: "Chennai",
    description:
      "Celebrating Independence Day with a cause that unites all – blood donation.",
  },
  {
    eventName: "2014 Youth Red Rally",
    date: "2014-09-12T09:00:00Z",
    venue: "IIT Delhi Campus",
    city: "Delhi",
    description:
      "Young India stepped up to support lives through a mass rally.",
  },
  {
    eventName: "Early Pulse - Pune",
    date: "2014-06-18T09:00:00Z",
    venue: "Fergusson College, Pune",
    city: "Pune",
    description: "Among Pune's first youth-led donation camps back in 2014.",
  },
  {
    eventName: "Blood Harmony 2014",
    date: "2014-11-22T09:00:00Z",
    venue: "Kala Ghoda, Mumbai",
    city: "Mumbai",
    description: "An art-and-donation camp that blended culture with care.",
  },
  {
    eventName: "Bengaluru Old Guard Drive",
    date: "2014-12-30T09:00:00Z",
    venue: "Brigade Road, Bangalore",
    city: "Bangalore",
    description:
      "Concluding 2014 with a heartwarming effort from local veterans.",
  },
  {
    ...
    city: "Mumbai",
    description:
      "Join the Blood Connect Drive in Mumbai to support local hospitals and save lives through your noble donation.",
  },
  {
    ...
    city: "Mumbai",
    description:
      "The youth of Mumbai are gathering for a powerful blood donation rally – your contribution can make a big difference!",
  },
  {
    ...
    city: "Mumbai",
    description:
      "A city-wide Rakta Utsav at the heart of Mumbai – step in and become someone’s hero today.",
  },
  {
    ...
    city: "Mumbai",
    description:
      "This May Day, give the gift of life. Participate in Mumbai’s Red Drop Day and save lives.",
  },
  {
    ...
    city: "Mumbai",
    description:
      "Walk in and donate! Join us for a local blood camp in Andheri this morning.",
  },
  {
    ...
    city: "Mumbai",
    description:
      "4 March ko Mumbai mein ho raha hai Maha Raktdaan Abhiyaan. Ek boond khoon kisi ki saans ban sakti hai – aaiye aur is mahaabhiyan ka hissa baniye!",
  },
  {
    ...
    city: "Mumbai",
    description:
      "February mein Mumbai mein hoga Lifeline Blood Donation Camp – ek zaruratmand ke liye aap hi ho sakte hain devdoot.",
  },
  {
    ...
    city: "Kolkata",
    description:
      "Support the Blood Warriors Drive in Kolkata and become a lifesaver in just a few minutes.",
  },
  {
    ...
    city: "Kolkata",
    description:
      "Donate blood. Be a hero. Join us in Kolkata for a meaningful cause this May.",
  },
  {
    ...
    city: "Kolkata",
    description:
      "Rakta Seva Mela is back with energy and hope – join Kolkata's biggest blood donation drive.",
  },
  {
    ...
    city: "Kolkata",
    description:
      "This May Day, be someone’s lifeline. Join the Kolkata Mayday blood camp at South City.",
  },
  {
    ...
    city: "Kolkata",
    description:
      "Walk in to donate and walk out a hero. Today’s Dumdum blood camp awaits your support.",
  },
  {
    ...
    city: "Kolkata",
    description:
      "Start the year with kindness. Join us in February for a life-saving cause in Kolkata.",
  },
  {
    ...
    city: "Kolkata",
    description:
      "Join the vibrant celebration of blood donation at Deshapriya Park this March!",
  },
  {
    ...
    city: "Delhi",
    description:
      "Run to donate – join Delhi’s first Blood Drive Marathon and save a life with every step.",
  },
  {
    ...
    city: "Delhi",
    description:
      "Dil se dena hai toh raktdaan kariye – be a part of Delhi’s largest donation drive!",
  },
  {
    ...
    city: "Delhi",
    description:
      "Let your blood pulse through others – donate in Delhi’s Red Pulse camp.",
  },
  {
    ...
    city: "Delhi",
    description:
      "Celebrate this day of labor by giving the gift of life at Saket.",
  },
  {
    ...
    city: "Delhi",
    description:
      "Your presence today can be someone’s miracle. Join us at the Dwarka blood camp.",
  },
  {
    ...
    city: "Delhi",
    description:
      "Donate hope, donate blood. Join our March campaign at Rajiv Chowk.",
  },
  {
    ...
    city: "Delhi",
    description:
      "Nayi subah ka arambh ek acchi karm se – donate blood this February in Delhi.",
  },
  {
  ...
  },
  {
    ...
    city: "Hyderabad",
    description:
      "Join the festive vibe and noble cause – Hyderabad needs your drop!",
  },
  {
    ...
    city: "Hyderabad",
    description:
      "Support the blood revolution in Hyderabad. Every unit counts!",
  },
  {
    ...
    city: "Hyderabad",
    description:
      "Start your day by saving a life. Join the May Day donation event in Ameerpet.",
  },
  {
    ...
    city: "Hyderabad",
    description:
      "Be the lifeline someone needs. Donate this morning in Begumpet.",
  },
  {
    ...
    city: "Hyderabad",
    description:
      "Ganga jaisa pavitra – apka khoon kisi ko nayi zindagi de sakta hai.",
  },
  {
    ...
    city: "Hyderabad",
    description:
      "Seva ka sabse shresth roop – raktdaan! Join our February campaign in Hyderabad.",
  },
  {
    ...
    city: "Bangalore",
    description:
      "Bangalore’s biggest summer blood bash is here – be a part of the revolution.",
  },
  {
    ...
    city: "Bangalore",
    description:
      "Donate blood. Get blessings. Enjoy a joyful donation day at Forum Mall.",
  },
  {
    ...
    city: "Bangalore",
    description:
      "Red is the color of life – and you can bring it to someone’s world today!",
  },
  {
    ...
    city: "Bangalore",
    description:
      "Blood donation camp this morning at MG Road – be the reason someone smiles today.",
  },
  {
  ...
  },
  {
    ...
    city: "Bangalore",
    description:
      "Sankalp lekar aaye hain hum – donate blood in March and spread hope.",
  },
  {
    ...
    city: "Bangalore",
    description:
      "Join techies and students in a heartful campaign to donate blood in February!",
  },
];
