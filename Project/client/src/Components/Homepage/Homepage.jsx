...
const testimonials = [
  {
    ...
    author: "Raj Tripathy",
    avatar: "https://media.istockphoto.com/id/1406197730/photo/portrait-of-a-young-handsome-indian-man.jpg?s=612x612&w=0&k=20&c=CncNUTbw6mzGsbojks2Vt0kV85N_pQaI3zaSkBQJFTc=",
    stars: 5,
  },
  {
  ...
  },
  {
    ...
    author: "Soumili Das",
    avatar: "https://media.istockphoto.com/id/1338134319/photo/portrait-of-young-indian-businesswoman-or-school-teacher-pose-indoors.jpg?s=612x612&w=0&k=20&c=Dw1nKFtnU_Bfm2I3OPQxBmSKe9NtSzux6bHqa9lVZ7A=",
    stars: 5,
  },
];
...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-white p-5">
      ...
      >
        <h2 className="text-4xl text-center font-bold font-serif mb-6">Our Impact</h2>
        <motion.div
        ...
        >
          {[
            ...
            <motion.div key={index} className="flex flex-col items-start justify-center bg-red-600 rounded-xl p-6 shadow-lg" variants={itemVariants}>
              <h3 className="text-5xl text-white">{stat.value}</h3>
              <p className="text-xl text-yellow-400 font-semibold">{stat.label}</p>
            </motion.div>
          ))}
        </motion.div>
      </motion.div>
      ...
      <div className="py-11 px-6">
        <div className="flex gap-12 justify-center mb-6">
          <Link to="/SearchBlood">
            <button
              className={`px-10 py-6 rounded-full text-2xl font-itim transition ${
                activeTab === 'blood' ? 'bg-red-600 text-white shadow-lg font-serif' : 'bg-gray-200 text-gray-800 font-serif'
              }`}
          ...
          <button
            className={`px-10 py-6 rounded-full text-2xl font-itim transition ${
              activeTab === 'event' ? 'bg-red-600 text-white shadow-lg font-serif' : 'bg-gray-200 text-gray-800 font-serif'
            }`}
            onClick={() => {
              setActiveTab('event');
      ...
      >
        <h2 className="text-4xl text-center font-bold font-serif mb-8">What Our Users Say</h2>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <div className="flex flex-col items-center">
                ...
                <p className="mt-2 font-semibold text-red-600">- {testimonials[currentSlide].author}</p>
                <div className="text-yellow-400 text-xl mt-1">
                  {'★'.repeat(testimonials[currentSlide].stars)}{'☆'.repeat(5 - testimonials[currentSlide].stars)}
                </div>
              </div>
            </motion.div>
          </AnimatePresence>
