...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-white p-5">
      ...
      >
        <h2 className="text-4xl text-center font-bold font-Itim mb-6 font-itim font-serif">Our Impact</h2>
        <motion.div
        ...
        >
          <motion.div className=" flex flex-col items-start justify-center bg-red-600 rounded-xl p-6 shadow-lg font-itim " variants={itemVariants}>
          ...
          <motion.div className="flex flex-col items-start justify-center bg-red-600 rounded-lg p-6 shadow-lg font-itim" variants={itemVariants}>
      ...
      <div className="py-11 px-6">
        ...
        <div className="text-center">
          {activeTab === 'blood' ? (
            <p className="text-2xl font-semibold font-itim font-sans text-red-600">
